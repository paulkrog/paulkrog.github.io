...
\cventry{Jun 2017}{Student Participant}{Oregon Programming Languages Summer
      ...
      \parbox{0.75\linewidth}{
        \begin{itemize}
        \item Experimented with leading research software and
          techniques: Idris and PLT Redex.
...
\cventry{Jan 2017--May 2017}{Research Assistant}{Purdue
  University -- Machine Learning for SAT Project }{West
...
\item \textbf{Programming Languages:} \\
  ...
  \\ Medium proficiency: Haskell, Java, Matlab, Verilog
  \\ Basic exposure: Idris, Racket, x86 ISA, MIPS ISA, Lisp, Jekyll/HTML/(S)CSS
