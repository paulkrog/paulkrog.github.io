...
\address{1010 W University Ave, Urbana, IL, 61801}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\vspace{8pt}
\item[] Deciding Memory Safety for Forest Data Structures. Umang Mathur,
  Adithya Murali, Paul Krogmeier, P. Madhusudan, Mahesh
  Viswanathan. Under
  submission. \MYhref{http://umathur3.web.engr.illinois.edu/papers/memsafety.pdf}{Preprint.}
\vspace{8pt}
...
\cventry{Aug 2018--present}{Research Assistant (advised by Madhusudan
...
\item \textbf{Programming Languages:} \\
  ...
  \\ Medium proficiency: Haskell, Prolog, Java, Matlab, Verilog
  \\ Basic exposure: Idris, Racket, x86 ISA, MIPS ISA, Lisp, Jekyll/HTML/CSS
