...
\item{\cventry{2016--present}{ M.S. Computer Engineering}{Purdue
  ...
  \item{\textbf{Teaching Assistant:}}
    ...
    \end{itemize}
  \item{\textbf{Masters Project ('Formalization of
        Fiat in Coq'):} \small{I'm working on proving type safety for
        the Fiat specification language in Coq. Additionally, I'm
